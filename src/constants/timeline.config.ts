...
export default [
  {
    ...
    content: {
      ...
      desc: "Recently, I've been looking for a way to stop developers from relying on unoriginal, cloned design patterns that appear everywhere — from poorly crafted code(I know it's contraversial) snippets to violations of the DRY principle, where simplicity should always take precedence over unnecessary complexity. MotionProvider emerged as the answer, and playgrounds became the ideal approach. It offers everything needed to push the boundaries of animation, empowering developers to create with freedom and creativity among 16K pre-defined animation combinations.",
      techs: [
        "typescript",
        "react",
        "redux",
      ...
      plainLink: "https://motionprovider.dev",
    },
  },
  {
    title: "Q3 2025",
