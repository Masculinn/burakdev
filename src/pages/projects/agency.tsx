import { Code, Expand, MousePointerClick } from "lucide-react";
...
const heroContent = {
  ...
  description: `A collection of 10,000 worldly Koalas each with their unique
...
export default function Agency() {
  ...
  return (
    <>
      <Head>
        <title>Motion Provider - Modern Agency Landing App</title>
      </Head>
        ...
        <div className="relative flex flex-col items-center justify-center px-8 py-10 min-h-[70vh] z-30 ">
          ...
          <div className="relative z-40 max-w-xl text-center flex items-center justify-center flex-col gap-4 ">
            ...
            <div className="flex lg:flex-row flex-col items-center justify-center gap-2">
              <Button
                className="bg-[#02C173] px-8 py-3 rounded-lg flex items-center hover:scale-105 transition-transform w-full"
                disabled={reverseAnimation}
                onClick={handleReverse}
              >
                <Code className="mr-2" />
                <span>{reverseAnimation ? "Hide" : "Show"} Code</span>
              </Button>
          ...
          children={
            <div className="backdrop-blur-md border border-stone-900 items-center justify-center lg:max-w-3xl lg:mx-auto h-2/3 w-full rounded-lg text-black">
              ...
              <CodeProvider
                ...
                code={projectsLib.agency.code}
                desc={projectsLib.agency.desc}
                rounded
                showLineNumbers
                fontSize="sm"
                appTheme="dark"
